...
def test_prepare_target_repo_rejects_autogenerated_default_branch(
    monkeypatch: pytest.MonkeyPatch,
    tmp_path: Path,
) -> None:
    def fake_run_command(
    ...
    message = str(exc.value)
    assert "auto-generated PRFactory branch" in message
    assert "prfactory/demo-123" in message
