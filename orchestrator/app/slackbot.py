...
def _title_prompt_blocks(*, mode: str, seed_prompt: str = "") -> list[dict[str, Any]]:
...
def _repo_selection_mutable(session: IntakeSession) -> bool:
    return session.mode == "create" and _session_intake_mode(session) == INTAKE_MODE_DEVELOPER
...
def _start_create_intake(
    ...
    *,
    ...
    controls_message = client.chat_postMessage(
        ...
        blocks=_title_prompt_blocks(mode=_session_intake_mode(session), seed_prompt=normalized_seed_prompt),
    )
